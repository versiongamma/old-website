                ...
                <GameContainer>
                  <DetailsContainer>
                    <Typography variant="h4">
                      Console Object Orientation
                    </Typography>
                    <Text> - Console Application with Win32</Text>
                    <Text>
                      {" "}
                      - Learning CPP, more specifically class based CPP
                    </Text>
              ...
              <Grid item xs={12}>
                <GameContainer>
                  <DetailsContainer>
                    ...
                    <Text>
                      {" "}
                      - Animated sprites, the concept of reducing texture
                      swapping with complete textures
                    </Text>
                    ...
                    <Text>
                      {" "}
                      - Concept of scene state, storing all entities in the
                      scene to be processes
                    </Text>
                    <TextLink href="">Possibly a source code link?</TextLink>
                  </DetailsContainer>
                  <img
              ...
              <Grid item xs={12}>
                <GameContainer>
                  <DetailsContainer>
                    ...
                    <Text>
                      {" "}
                      - Lessons learned through the iteration, that the scene
                      state concept was not efficient, but could be repurposed
